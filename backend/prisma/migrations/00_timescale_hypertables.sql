-- Create raw time-series tables (not managed by Prisma migrations)
...
-- Promote to TimescaleDB hypertables
...
-- Compression: compress vital_readings chunks older than 30 days
...
-- Retention: drop raw chunks older than 2 years
